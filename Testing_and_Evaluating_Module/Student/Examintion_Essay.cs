...
namespace Testing_and_Evaluating_Module.Student
{
    public partial class Examintion_Essay : Form
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["MCQ_ConString"].ConnectionString);//Connection Property         
        #endregion
        ...
        private void Examintion_Essay_Load(object sender, EventArgs e)
        {
            ...
            //  this.teacher_Add_Essay_Question_1TableAdapter.Fill(this.E_Blind_Learning_SystemDataSet9.Teacher_Add_Essay_Question_1);
